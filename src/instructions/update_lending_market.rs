...
pub const UPDATE_LENDING_MARKET_DISCRIMINATOR: [u8; 8] = [209, 157, 53, 210, 97, 180, 31, 45];
...
impl UpdateLendingMarket {
  pub fn instruction(&self, args: UpdateLendingMarketInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: UpdateLendingMarketInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
