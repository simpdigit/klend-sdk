...
pub const INIT_RESERVE_DISCRIMINATOR: [u8; 8] = [138, 245, 71, 225, 153, 4, 3, 43];
...
pub struct InitReserveBuilder {
            lending_market_owner: Option<solana_pubkey::Pubkey>,
                ...
                fee_receiver: Option<solana_pubkey::Pubkey>,
                reserve_collateral_mint: Option<solana_pubkey::Pubkey>,
                reserve_collateral_supply: Option<solana_pubkey::Pubkey>,
                initial_liquidity_source: Option<solana_pubkey::Pubkey>,
...
impl InitReserveBuilder {
  pub fn new() -> Self {
    ...
    pub fn reserve_liquidity_supply(&mut self, reserve_liquidity_supply: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn fee_receiver(&mut self, fee_receiver: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn reserve_collateral_mint(&mut self, reserve_collateral_mint: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn reserve_collateral_supply(&mut self, reserve_collateral_supply: solana_pubkey::Pubkey) -> &mut Self {
                        self.reserve_collateral_supply = Some(reserve_collateral_supply);
                    self
    }
            #[inline(always)]
    pub fn initial_liquidity_source(&mut self, initial_liquidity_source: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub struct InitReserveCpiAccounts<'a, 'b> {
              ...
              pub fee_receiver: &'b solana_account_info::AccountInfo<'a>,
              ...
              pub initial_liquidity_source: &'b solana_account_info::AccountInfo<'a>,
...
impl<'a, 'b> InitReserveCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn reserve_liquidity_supply(&mut self, reserve_liquidity_supply: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn fee_receiver(&mut self, fee_receiver: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn reserve_collateral_supply(&mut self, reserve_collateral_supply: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn initial_liquidity_source(&mut self, initial_liquidity_source: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
struct InitReserveCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_account_info::AccountInfo<'a>,
            lending_market_owner: Option<&'b solana_account_info::AccountInfo<'a>>,
                ...
                fee_receiver: Option<&'b solana_account_info::AccountInfo<'a>>,
                ...
                initial_liquidity_source: Option<&'b solana_account_info::AccountInfo<'a>>,
