...
pub const UPDATE_GLOBAL_CONFIG_ADMIN_DISCRIMINATOR: [u8; 8] = [184, 87, 23, 193, 156, 238, 175, 119];
...
impl<'a, 'b> UpdateGlobalConfigAdminCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn pending_admin(&mut self, pending_admin: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
