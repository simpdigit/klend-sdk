...
pub const INIT_LENDING_MARKET_DISCRIMINATOR: [u8; 8] = [34, 162, 116, 14, 101, 137, 94, 239];
...
impl InitLendingMarket {
  pub fn instruction(&self, args: InitLendingMarketInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitLendingMarketInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
