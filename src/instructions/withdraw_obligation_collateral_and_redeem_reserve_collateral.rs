...
pub const WITHDRAW_OBLIGATION_COLLATERAL_AND_REDEEM_RESERVE_COLLATERAL_DISCRIMINATOR: [u8; 8] = [75, 93, 93, 220, 34, 150, 218, 196];
...
impl WithdrawObligationCollateralAndRedeemReserveCollateral {
  pub fn instruction(&self, args: WithdrawObligationCollateralAndRedeemReserveCollateralInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawObligationCollateralAndRedeemReserveCollateralInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
