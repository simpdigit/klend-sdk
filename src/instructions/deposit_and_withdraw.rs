...
pub const DEPOSIT_AND_WITHDRAW_DISCRIMINATOR: [u8; 8] = [141, 153, 39, 15, 64, 61, 88, 84];
...
impl DepositAndWithdraw {
  pub fn instruction(&self, args: DepositAndWithdrawInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DepositAndWithdrawInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
