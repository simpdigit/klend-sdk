...
pub const DEPOSIT_OBLIGATION_COLLATERAL_V2_DISCRIMINATOR: [u8; 8] = [137, 145, 151, 94, 167, 113, 4, 145];
...
impl DepositObligationCollateralV2 {
  pub fn instruction(&self, args: DepositObligationCollateralV2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DepositObligationCollateralV2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
