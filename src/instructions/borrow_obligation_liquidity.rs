...
pub const BORROW_OBLIGATION_LIQUIDITY_DISCRIMINATOR: [u8; 8] = [121, 127, 18, 204, 73, 245, 225, 65];
...
impl BorrowObligationLiquidity {
  pub fn instruction(&self, args: BorrowObligationLiquidityInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: BorrowObligationLiquidityInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
