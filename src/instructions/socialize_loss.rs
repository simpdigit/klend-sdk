...
pub const SOCIALIZE_LOSS_DISCRIMINATOR: [u8; 8] = [245, 75, 91, 0, 236, 97, 19, 3];
...
impl SocializeLoss {
  pub fn instruction(&self, args: SocializeLossInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SocializeLossInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
