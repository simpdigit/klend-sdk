...
pub const MARK_OBLIGATION_FOR_DELEVERAGING_DISCRIMINATOR: [u8; 8] = [164, 35, 182, 19, 0, 116, 243, 127];
...
impl MarkObligationForDeleveraging {
  pub fn instruction(&self, args: MarkObligationForDeleveragingInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: MarkObligationForDeleveragingInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
