...
pub const BORROW_OBLIGATION_LIQUIDITY_V2_DISCRIMINATOR: [u8; 8] = [161, 128, 143, 245, 171, 199, 194, 6];
...
impl BorrowObligationLiquidityV2 {
  pub fn instruction(&self, args: BorrowObligationLiquidityV2InstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: BorrowObligationLiquidityV2InstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
pub struct BorrowObligationLiquidityV2Builder {
            owner: Option<solana_pubkey::Pubkey>,
                ...
                borrow_reserve: Option<solana_pubkey::Pubkey>,
                borrow_reserve_liquidity_mint: Option<solana_pubkey::Pubkey>,
                reserve_source_liquidity: Option<solana_pubkey::Pubkey>,
                borrow_reserve_liquidity_fee_receiver: Option<solana_pubkey::Pubkey>,
...
impl BorrowObligationLiquidityV2Builder {
  pub fn new() -> Self {
    ...
    pub fn lending_market_authority(&mut self, lending_market_authority: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn borrow_reserve(&mut self, borrow_reserve: solana_pubkey::Pubkey) -> &mut Self {
                        self.borrow_reserve = Some(borrow_reserve);
                    self
    }
            #[inline(always)]
    pub fn borrow_reserve_liquidity_mint(&mut self, borrow_reserve_liquidity_mint: solana_pubkey::Pubkey) -> &mut Self {
    ...
    pub fn reserve_source_liquidity(&mut self, reserve_source_liquidity: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn borrow_reserve_liquidity_fee_receiver(&mut self, borrow_reserve_liquidity_fee_receiver: solana_pubkey::Pubkey) -> &mut Self {
...
impl<'a, 'b> BorrowObligationLiquidityV2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn lending_market_authority(&mut self, lending_market_authority: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn borrow_reserve(&mut self, borrow_reserve: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.borrow_reserve = Some(borrow_reserve);
                    self
    }
      #[inline(always)]
    pub fn borrow_reserve_liquidity_mint(&mut self, borrow_reserve_liquidity_mint: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn reserve_source_liquidity(&mut self, reserve_source_liquidity: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn borrow_reserve_liquidity_fee_receiver(&mut self, borrow_reserve_liquidity_fee_receiver: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
